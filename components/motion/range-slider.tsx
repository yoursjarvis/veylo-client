...
export function RangeSlider({
  ...
  return (
    <div
      ...
      className={cn(
        "relative flex h-10 w-full touch-none items-center overflow-hidden rounded-lg bg-muted select-none",
        disabled
    ...
    >
      ...
      <motion.div
        ...
        className="absolute top-1/2 h-5 w-1.5 rounded-sm bg-foreground shadow-sm ring-foreground/30 outline-none focus-visible:ring-4"
