...
import {
  usePermissions as useCatalogPermissions,
...
export function RoleFormModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="flex max-h-[90vh] max-w-[600px] flex-col gap-0 overflow-hidden p-0">
                ...
                <div className="flex flex-row items-center justify-between rounded-lg border border-border/50 p-4">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Users with this role will have full access to all
                      resources. Only the organization owner can manage this.
                    </p>
                  </div>
