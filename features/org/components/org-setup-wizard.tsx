...
export function OrgSetupWizard() {
  ...
  const form = useForm({
    ...{
      ...
      onSubmit: async ({
        ...
        value: { name: string; slug: string; workspaceName: string }
      }) => {
        try {
  ...
  return (
    <div className="flex animate-in flex-col space-y-8 duration-500 fade-in slide-in-from-bottom-4">
      ...
      <div className="mb-4 flex items-center justify-center gap-2">
        <div
          className={`h-2 w-12 rounded-full transition-colors ${step >= 1 ? "bg-primary" : "bg-muted"}`}
        />
        <div
      ...
      >
        {step === 1 && (
          <div className="animate-in space-y-5 slide-in-from-right-4">
                ...
                {logoPreview ? (
                  ...
                  <div className="flex flex-col items-center text-muted-foreground">
                    <HugeiconsIcon
                      ...
                      className="mb-1"
                    />
                    <span className="text-2xs font-medium tracking-wider uppercase">
                      Upload Logo
                    </span>
                  </div>
                )}
            ...
            <form.Field
              ...
              listeners={{
                onChange: ({ value }: { value: string }) => {
                  ...
                  if (
                    !currentSlug ||
                    currentSlug === autoGenerateSlug(value.slice(0, -1))
                  ) {
              ...
              {(field) => (
                <Field>
                  ...
                  <p className="mt-1.5 text-xs text-muted-foreground">
                    Workspaces are dedicated areas for specific teams or large
                    projects.
                  </p>
                  <FieldError errors={field.state.meta.errors} />
                </Field>
