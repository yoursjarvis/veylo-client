    ...
    <div className="space-y-6">
      ...
      {isFieldsLoading ? (
        ...
        <div className="grid max-w-5xl grid-cols-1 gap-6 lg:grid-cols-2">
          ...
          <Card className="border border-border bg-card text-foreground shadow-md">
            <CardHeader>
          ...
          {canCreate && (
            <Card className="h-fit border border-border bg-card text-foreground shadow-md">
              <CardHeader>
                <CardTitle className="text-sm font-semibold">
                  Create Custom Field
                </CardTitle>
                  ...
                  >
                    {(field) => {
                      ...
                      if (fieldValidationErrors.name)
                        fieldErrors.push(fieldValidationErrors.name)
                      const hasError =
                      ...
                      return (
                        ...
                        >
                          {(field) => {
                            ...
                            if (fieldValidationErrors.options)
                              fieldErrors.push(fieldValidationErrors.options)
                            const hasError =
                              field.state.meta.isTouched && !!fieldErrors.length
                            return (
                              <div className="space-y-1.5">
