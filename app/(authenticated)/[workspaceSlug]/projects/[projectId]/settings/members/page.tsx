...
export default function ProjectMembersPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col justify-between gap-4 border-b b-5 sm:flex-row sm:items-center">
        <div>
        ...
        <Button
          ...
          className="h-9 rounded-lg bg-primary text-xs font-semibold "
        >
        ...
        <Card className="shadow-md">
          ...
          <CardContent className="space-y-4">
            ...
            selectedProject.members.length === 0 ? (
              ...
              <div className="divide-slate-850 divide-y">
                {selectedProject?.members?.map((member: ProjectMember) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <span className="rounded-full px-2.5 py-0.5 text-[9px] font-semibold tracking-wider uppercase">
                        {member.role || "Member"}
                      </span>
                      <Button
                        variant="ghost"
                        size="icon"
                        className="hover:text-rose-450 h-8 w-8 text-rose-500 hover:bg-rose-500/10"
                        onClick={() => {
                          if (
                            confirm(
                ...
                return (
                  ...
                  >
                    ...
                    <input
                      type="checkbox"
                      checked={isChecked}
                      className="h-4.5 w-4.5 rounded border-slate-800 bg-slate-950 text-primary accent-indigo-500 focus:ring-primary/20"
                      onChange={() => {
                        if (isChecked) {
